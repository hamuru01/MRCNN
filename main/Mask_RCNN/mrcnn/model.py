...
class MaskRCNN(object):
    ...
    def build(self, mode, config):
        ...
        if mode == "training":
            ...
            """ì¼€ë¼ìŠ¤ì—ì„œ ìƒìˆ˜ ë ˆì´ì–´ì— í•´ë‹¹í•˜ëŠ” ë ˆì´ì–´ê°€ ì—†ì–´ì„œ ëžŒë‹¤ ë ˆì´ì–´ë¥¼ ì‚¬ìš©í•˜ëŠ” íŽ¸ë²•ì´ ìžˆì—ˆëŠ”ë°
            ì´ì œ í†µí•˜ì§€ ì•ŠëŠ”ë‹¤!
            ê·¸ê±´ ê·¸ë ‡ê³  ì¸í’‹ í•¨ìˆ˜ê°€ ìžˆëŠ”ë° ì™œ ì €ë ‡ê²Œ ì§ ê±°ì§€??? ì•„ë¬´íŠ¼ ì»¤ìŠ¤í…€ ë ˆì´ì–´ ìž‘ì„±í•´ì„œ ìƒìˆ˜ í…ì„œë¥¼ ë¦¬í„´í•´ì£¼ê¸°ë¡œ í•¨.
            """
